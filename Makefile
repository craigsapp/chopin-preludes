...
##                for the preludes of Frederic Chopin.
##
...
#           git clone https://github.com/craigsapp/chopin-preludes
#
...
kernscores: humdrum-extras-check
	mkdir -p kernscores; (cd kernscores && humsplit h://chopin/preludes)
	@echo "[0;32m"
...
ifeq ($(shell which curl),)
	...
	for file in kern/*.krn; do \
	   ...
	   curl \
	      "http://kern.humdrum.org/data?l=chopin/preludes&file=$$TBASE.krn&format=pdf" \
...
ifeq ($(wildcard .git),)
	...
	@echo "***    [0;32mgit clone https://github.com/craigsapp/chopin-preludes[0;31m"
	@echo "[0m"
	exit 1
endif
